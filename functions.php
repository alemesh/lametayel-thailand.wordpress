...
//        wp_enqueue_style('lametayel_restaurants-page_style_css', get_stylesheet_directory_uri() . '/restaurants-page-styles/css/restaurants-main.css');
    ...
    if ( is_page_template('about-page.php') || is_tax( 'destinations') || is_singular('attraction') || is_singular('hotel') || is_archive() || is_singular('branch') || is_home() || is_tax( 'packages') || is_page()) {
