...
//        wp_enqueue_style('lametayel_restaurants-page_style_css', get_stylesheet_directory_uri() . '/restaurants-page-styles/css/restaurants-main.css');
    ...
    if ( is_page_template('page-flights.php') || is_page_template('page-attractions.php') ||  is_page_template('search-attractions.php') || is_tax( 'destinations') || is_page_template('page-hotels.php')  || is_page_template('page-destinations.php') ) {
        wp_enqueue_style('lametayel_flights-page_style_css', get_stylesheet_directory_uri() . '/flights-page-styles/css/main.min.css');
    }

    if ( is_page_template('about-page.php') || is_tax( 'destinations') || is_singular('attraction') || is_singular('hotel') || is_archive() || is_singular('branch') || is_home() || is_tax( 'packages') || is_page() || is_singular('flight')) {
    ...
    if (is_page_template('page-contact.php') || is_page_template('page-jobs.php')){
        wp_enqueue_style('contact_page_page_styles_css', get_stylesheet_directory_uri() . '/contact-page-styles/css/main.min.css');
...
//        wp_enqueue_script('lametayel_restaurants-page_googlemaps_css');
    ...
    if ( is_page_template('page-flights.php') || is_page_template('page-attractions.php') || is_tax( 'destinations') || is_page_template('page-hotels.php')   || is_page_template('page-destinations.php')) {
    ...
    if (is_page_template('page-contact.php') || is_page_template('page-jobs.php')){
        wp_register_script('contact_page_page_scripts', get_stylesheet_directory_uri() . '/contact-page-styles/js/scripts.min.js', array(), false, true);
        wp_enqueue_script('contact_page_page_scripts');
    }
